        ...
        <div className="container">
            ...
            <div className="show">
                <div className="stat-container-title">
                    ...
                    <p style={{width: "180px", color: "black"}}>No. 
                    {id}</p>
                    <p>{name}</p>
                ...
                <div style={{display: "flex", width: "100%"}}>
                    <div style = {{background: "#dbdbd9", textAlign: "center"}}
                ...
                <div className="base-stats">
                    <div>
                        {statsName.map((stats) => (<p className="stats">{stats}</p>
                        ))}
                    </div>
                    <div>
                        {stats.map((stats) => (<p className="stats">{stats}</p>
                        ))}
                    </div>
                </div>
            </div>
